...
public class KhuyenMaiService {
    ...
    public List<VoucherSuggestionResponse> getVoucherSuggestions(UUID idHoaDon) {
        ...
        List<VoucherSuggestionResponse> suggestions = phieuGiamGias.stream()
                .filter(pgg -> {
                    ...
                    // Kiểm tra số lượng còn lại (với voucher thường)
                    ...
                    if (Boolean.TRUE.equals(pgg.getRiengTu())) {
                        ...
                        boolean daSuDung = hoaDonRepository
                                .existsByIdKhachHang_IdAndIdPhieuGiamGia_IdAndTrangThaiNotAndIdNot(
                                        idKhachHang, pgg.getId(), TrangThaiHoaDon.DA_HUY, idHoaDon);
                        if (daSuDung) {
    ...
    private void validateVoucher(PhieuGiamGia phieuGiamGia, HoaDon hoaDon) {
        ...
        // 4.3. Kiểm tra số lượng còn lại (với voucher thường)
